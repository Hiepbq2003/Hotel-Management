    ...
    const openModal = (room = null) => {
        ...
        if (room) {
            ...
            setCurrentRoom({
                ...
                bedInfo: "", description: "", image: "", code: ""
            });
        }
        setError(null);
        setShowModal(true);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditing) {
                ...
                await api.post("/room-type", dataToSend, { params: { hotelId: DEFAULT_HOTEL_ID } });
        ...
        <div className="container mt-4">
            ...
            <div className="shadow-2xl rounded-xl table-responsive bg-white p-3 border border-gray-200">
                <Table striped bordered hover className="m-0 align-middle caption-top" style={{ minWidth: '1200px' }}>
                    ...
                    <tbody>
                        {roomTypes.length > 0 ? (
                            roomTypes.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE).map((room) => (
                                <tr key={room.id} className="align-middle">
                                    ...
                                    <td className="text-center">
                                        <img
                                            src={room.image || "https://via.placeholder.com/80x60?text=No+Image"}
                                            alt={room.name}
                                            width="80"
                                            height="60"
