...
const GalleryCard = ({ img, height, title, sub, isLarge = false }) => (
    <div className="modern-g-card" style={{
        ...
        <style dangerouslySetInnerHTML={{ __html: `
            ...
            .modern-g-card:hover { transform: translateY(-5px); }
            @keyframes fadeInUp {
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            ...
                            <h2 style={{
                                ...
                                Welcome to <span style={{ color: MAIN_COLOR }}>Stella Horizon.</span>
                            </h2>
                            <p style={{ fontSize: '1.15rem', color: '#555', lineHeight: '1.8', maxWidth: '540px' }}>
                                Built during the Belle Époque period, this landmark hotel is located in the heart of the city.
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-lg-5">
                            <GalleryCard
                                ...
                                isLarge={true}
                                title="Infinity Pool"
                                sub="A breathtaking view from our rooftop oasis, perfect for summer days."
                            />
                        </div>
                    </div>
                </div>
